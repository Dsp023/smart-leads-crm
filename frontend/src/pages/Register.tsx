...
import { Mail, Lock, User, UserPlus, AlertCircle, Shield, Layers } from 'lucide-react';
      ...
      <div className="w-full max-w-[380px] space-y-6 py-12">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-xs text-slate-550 dark:text-slate-400 mt-1.5">
            Register your credentials to start managing leads
          </p>
        </div>
            ...
            <div className="space-y-1.5 text-left">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full pl-9 pr-3.5 py-2.5 rounded-lg border border-slate-200/60 dark:border-slate-900/60 bg-slate-50/50 dark:bg-[#07080c] text-slate-900 dark:text-white text-xs focus:outline-none focus:ring-1 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all cursor-pointer"
                >
                  <option value="Sales User" className="bg-white dark:bg-[#0d0f17] text-slate-900 dark:text-white">Sales User (Read/Write)</option>
                  <option value="Admin" className="bg-white dark:bg-[#0d0f17] text-slate-900 dark:text-white">Admin (Full access + Lead Deletion)</option>
                </select>
              </div>
            </div>
